...
def get_equation_std_data(train_data_dir, test_data_dir, sign_dir_lists, sign_output_lists, shape = (28, 28), train_max_equation_len = 10, test_max_equation_len = 10, system_num = 2, tmp_file_prev =
None, seed = None, train_num_per_len = 10, test_num_per_len = 10, is_color = False):
    ...
    train_pool = get_sign_path_list(train_data_dir, sign_dir_lists)
    test_pool = get_sign_path_list(test_data_dir, sign_dir_lists)
...
if __name__ == "__main__":
    train_data_dirs = ["../dataset/cifar10_images_train"]#"../dataset/mnist_images", "../dataset/random_images"] #, "../dataset/cifar10_images"]
    test_data_dirs = ["../dataset/cifar10_images_test"]
    tmp_file_prevs = ["cifar10_equation_data"]#"mnist_equation_data", "random_equation_data"] #, "cifar10_equation_data"]
    for train_data_dir, test_data_dir, tmp_file_prev in zip(train_data_dirs, test_data_dirs, tmp_file_prevs):
        data = get_equation_std_data(train_data_dir = train_data_dir,\
                                     test_data_dir = test_data_dir,\
                                     sign_dir_lists = ['0', '1', '3', '7'],\
                                     sign_output_lists = ['0', '1', '+', '='],\
                                     shape = (32,32),\
                                     train_max_equation_len = 7, \
                                     test_max_equation_len = 7, \
                                     system_num = 2, \
                                     tmp_file_prev = tmp_file_prev, \
                                     train_num_per_len = 8000, \
                                     test_num_per_len = 1000, \
                                     is_color = True)
